...
int main (int argc, char ** argv) {
    ...
    if (entradaASCII == falso1 + falso2 + falso3 + falso4) {

        cin >> entrada5;
        entradaASCII = entradaASCII + entrada5;

    }

    /* Operador Ternário */

    //cout << (entradaASCII == falso1 + falso2 + falso3 + falso4) ? scanf("%c", &entrada5) + (entradaASCII = entradaASCII + entrada5) : entrada5;
